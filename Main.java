...
public class Main extends PApplet
{
   ...
   public void draw_overlay()
   {
      ...
      {
         MobileAnimatedActor m = (MobileAnimatedActor) occ;
         draw_checked(m.get_checked());
         draw_path(m.get_path());
      }
   }

   public void draw_checked(List<Point> pts)
   {
      fill(0,0,0,150);
      for(Point p : pts)
      {
   ...
   public void draw_path(List<Point> pts)
   {
      fill(255,0,0,200);
